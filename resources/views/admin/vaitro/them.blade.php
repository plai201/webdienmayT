    ...
    <div class="content-wrapper">
        ...
        <div class="content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <form action="{{route('roles.them-vai-tro')}}" method="post">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <textarea type="text" name="TenHienThi" class="form-control" id="exampleFormControlInput1" placeholder="Nhập mô tả vai trò"></textarea>
                            </div>
                                    ...
                                    <div class="card-header">
                                        ...
                                        <ul class="list-group list-group-flush">
                                            ...
                                            <li class="list-group-item ">
                                                <input type="checkbox" name="MaQuyen[]" value="{{$permissionChild->MaQuyen}}" class="checkbox_wrapper_child"> {{$permissionChild->TenQuyen}}
                                            </li>
                                            @endforeach
                                        </ul>
                                    </div>
