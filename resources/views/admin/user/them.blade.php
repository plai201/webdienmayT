    ...
    <div class="content-wrapper">
        ...
        <div class="content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6">
                        <form action="{{route('user.them-user')}}" method="post">
                            @csrf
                            <div class="form-group">
                                <label for="exampleFormControlInput1">Tên tài khoản</label>
                                <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" id="exampleFormControlInput1" placeholder="Nhập tên tài khoản">
                            </div>
                            @error('name')
                            ...
                            <div class="alert alert-danger thong-bao">{{ $message }}</div>
                            @enderror id="exampleFormControlInput1" placeholder="Nhập Email">
                            </div>
                            @error('email')
                            <div class="alert alert-danger thong-bao">{{ $message }}</div>
                            @enderror
                            <div class="form-group">
                                ...
                                <input type="text" name="password" class="form-control  @error('password') is-invalid @enderror" id="exampleFormControlInput1" placeholder="Nhập mật khẩu">
                            </div>
                            @error('password')
                            <div class="alert alert-danger thong-bao">{{ $message }}</div>
                            @enderror
